...
var util = { 
	...
	print_debug: console.log,
	hexstrdump: console.log }

var openpgp_packet_keymaterial = require('./keymat_packet.js').openpgp_packet_keymaterial
...
exports.openpgp_packet = new _openpgp_packet();
